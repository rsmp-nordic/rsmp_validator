...
layout: page
title: Operational
parmalink: operational
has_children: false
has_toc: false
parent: Site::Tlc::Modes
...
## Operational startup status is read with S0005 by intersection
...
## Operational switched on is read with S0007 with source
